...
const ReportCard = ({
  ...
  return (
    <Tooltip>
      {/* O Trigger deve ter apenas UM filho (o motion.div) */}
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                ...
                {/* Alterado para span para evitar erro de botão dentro de botão */}
                <span
                  role="button"
                  tabIndex={0}
                  onClick={(e) => {
                  ...
                  className="shrink-0 text-muted-foreground hover:text-accent transition-colors cursor-pointer"
                >
